...
<div>
  ...
  <div class="row">
    <div class="col-8">
      ...
      <dropzone id="anexosUpload2" ref="anexosUpload" :url="upload" useFontAwesome vdropzone-success="console.log('as')" v-if="upload && anexo.id==0" @vdropzone-success="arquivoUpload" @vdropzone-queue-complete="limparUpload" :language="upload_language" >
    ...
    <div class="col-4">
      ...
      <b-card class="lista-anexos">
        <div class="row" v-for="(attach, index) in attachs" :class="{'bg-faded': attach.id==anexo.id}">
        ...
        salvar_nome() {
          ...
          this.anexo.post(base_url + 'attach/nome/' + self.anexo.id)
            .then(function(response){
              ...
              self.attachs[self.anexo.index].name = self.anexo.name;
            });
        },
        limparUpload() {
        ...
        apagarAnexo(id, index){
          ...
          axios.get(base_url + 'attach/' + id + '/delete')
            .then(function(response, index){
              ...
              self.attachs.splice(self.anexo.index, 1);
