        ...
        <table  class="table">
          ...
          <tbody>
            <tr v-for="(produto, index) in nf.produtos">
              ...
              <td>
                <input-dinheiro addon=false disabled=true v-model="produto.valor_total" size="sm" titulo=false />
              </td>

              <td>
                <input-dinheiro addon=false disabled=true v-model="produto.icms_total" size="sm" titulo=false />
              </td>

              <td>
                <input-dinheiro addon=false disabled=true v-model="produto.ipi_total" size="sm" titulo=false />
              </td>
