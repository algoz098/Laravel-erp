            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="col-md-3">
                  ...
                  @else
                  <select class="form-control" id="tipo[0]" name="tipo[0]" disabled>
                    <option value="Produtos\Medidas" selected>Unidade de medida para produtos</option>
                  </select>
                  <input value="Produtos\Medidas" id="hidden" name="tipo[0]" type="hidden">
                  @endif
                </div>
                <div class="col-md-3" id="textHolder">
                  <label id="textLabel">Nome da medida (ex: Litros)</label>
                  <input value="{{{isset($combobox) ? $combobox->value : ""}}}" type="text" class="form-control" id="value" name="value">
                </div>
                <div class="col-md-3" id="textHolder">
                  <label id="textLabel">Nome reduzido: (ex: Lts)</label>
